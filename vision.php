                        ...
                        <div class="col-lg-6 col-md-6">
                            <div class="single-about-chose-us mb-95">
                                ...
                                <div class="about-choose-content text-green">
                                    <h3>Vision</h3>
                                    <span class="text-center">To be a first class educational institution with a reputation for academic excellence and strong Christian values’</span>
                                </div>
                            </div>
                        </div>
                        <div class="col-lg-6 col-md-6">
                            <div class="single-about-chose-us mb-95 about-negative-mrg">
                                ...
                                <div class="about-choose-content text-green">
                                    <h3>Mission </h3>
                                    <span class="text-center">To provide first class education for future leaders by combining academic excellence with spiritual and moral uprightness </span>
                                </div>
                            </div>
                        </div>
                    </div>
