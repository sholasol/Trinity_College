        ...
        <div class="container-fluid">
            ...
            <div class="row clearfix">
                <div class="col-lg-12 col-md-12 col-sm-12">
                    <div class="card">
                        <div class="header">
                            <h2><strong>Application for <?php echo $rx['fname'].' '.$rx['lname']; ?></strong> </h2>
                        </div>
                        <div class="body">
                            <form id="wizard_with_validation" method="POST" action="pay.php" enctype="multipart/form-data">
                                ...
                                <fieldset> 
                                           ...
                                           <tr>
                                               <td>
                                                  <div class="form-check form-check-inline">
                                                      <input class="form-check-input" type="radio" name="center" id="inlineRadio2" value="<?php echo $cen ?>" >
                                                    <label class="form-check-label" for="inlineRadio2">Chosen Center (<?php echo $cen ?>)</label>
                                                  </div> 
                                               </td>
                                               <td>
                                                   <div class="form-check form-check-inline">
                                                    <input class="form-check-input" type="radio" name="center" id="inlineRadio2" value="Ofada" required <?php echo $cl ?>>
                                   ...
                                   <div class="checkbox">
                                       <input id="remember_me" name="term" type="checkbox" required>
                               ...
                               <h3>Child's Details</h3>
                                <fieldset>
                                    <div class="form-group form-float">
                                        ...
                                        <input type="file" class="form-control"  name="passport" <?php echo $req ?> >
                                    </div>
                                    <div class="row">
                                    ...
                                    <div class="row">
                                       ...
                                       <div class="form-group form-float col-md-4">
                                           ...
                                           <div class="form-check form-check-inline">
                                            <input class="form-check-input" type="radio" name="gender" id="inlineRadio1" value="Female" <?php echo $reqq ?> <?php echo $fml ?>>
                                            <label class="form-check-label" for="inlineRadio1">Female</label>
                                          </div>
                                          <div class="form-check form-check-inline">
                                            <input class="form-check-input" type="radio" name="gender" id="inlineRadio2" value="Male" <?php echo $ml ?>>
