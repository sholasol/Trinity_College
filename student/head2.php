...
<aside id="leftsidebar" class="sidebar">
    ...
    <div class="menu">
        <ul class="list">
            ...
            <li><a href="survey"><i class="zmdi zmdi-apps"></i><span>Survey</span></a></li>
            <li><a href="newSurvey"><i class="zmdi zmdi-account-box"></i><span>New Survey</span></a></li>
