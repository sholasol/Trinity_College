...
//checking there are more than one student
        ...
        <div class="container-fluid">
            ...
            <div class="row clearfix">
                <div class="col-lg-12 col-md-12 col-sm-12">
                    <div class="card">
                        <div class="header">
                            <h2><strong>Application Edit for </strong>( <?php echo $rx['fname'].' '.$rx['lname']; ?>)</h2>
                        </div>
                        <div class="body">
                            <form id="wizard_with_validation" method="POST" action="payy.php" enctype="multipart/form-data">
                                ...
                                <fieldset> <br>
                                    ...
                                    <div class="form-check form-check-inline">
                                        ...
                                        <label class="form-check-label" for="inlineRadio2">
                                            <?php 
                                            if($stt =="Paid"){echo 'Registration Fee has been Paid';}else{echo 'Pay with bank code';}
                                            ?>
                                        ...
                                        <table class="table table-hover c_table theme-color ">
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    <td><?php echo $i; ?></td>
                                                    <td>
                                                        <a class="text-primary" href="edits?code=<?php echo $rn['studentcode']?>"><?php echo $rn['fname'].' '.$rn['lname']; ?></a>
                                                    </td>
                                                    <td><?php echo $rn['studentcode']?></td>
                                                    
                                                    <td>
                                                        <a class="text-primary" href="edits?code=<?php echo $rn['studentcode']?>">Edit</a>
                                                    </td>
                                                </tr>
                                                    <?php } ?>
                                            </tbody>
