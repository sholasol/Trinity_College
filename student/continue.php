                            ...
                            <form id="wizard_with_validation" method="POST" action="pay.php" enctype="multipart/form-data">
                                ...
                                <fieldset> 
                                   ...
                                   <div class="form-group form-float">
                                    <div class="checkbox">
                                        ...
                                        <label for="remember_me">I have read the terms and conditions.</label>
                                    </div>
                                    </div>
                                   <div class="form-group form-float">
                                           <label>Exam Venue</label><br>
                                           ...
                                           <div class="form-check form-check-inline">
                                            <input class="form-check-input" type="radio" name="center" id="inlineRadio1" value="Ofada">
                                            <label class="form-check-label" for="inlineRadio1">Ofada Center</label>
                                          </div>
                                           <div class="form-check form-check-inline">
                                            <input class="form-check-input" type="radio" name="center" id="inlineRadio2" value="Porthacourt">
                                            <label class="form-check-label" for="inlineRadio2">Port Harcout Center</label>
                                          </div>
                                           <div class="form-check form-check-inline">
                               ...
                               <h3>Personal Details</h3>
                                <fieldset>
                                    ...
                                    <div class="row">
                                        <div class="form-group form-float col-md-4">
                                            ...
                                            <input type="text" class="form-control" value="<?php echo $fn ?>" name="fname" required>
                                        </div>
                                        <div class="form-group form-float col-md-4">
                                            <label>Middle Name</label>
                                            <input type="text" class="form-control" placeholder="Other name" name="mname" >
                                        </div> 
                                        <div class="form-group form-float col-md-4">
                                            <label>Surname</label>
                                         <input type="text" class="form-control" value="<?php echo $ln ?>" name="lname" required>
                                       </div>
                                    </div>
                                    <div class="row">
                                        <div class="form-group form-float col-md-4">
                                            <label>Phone</label>
                                            <input type="text" class="form-control" value="<?php echo $phn ?>" name="phone" required>
                                        </div>
                                        <div class="form-group form-float col-md-4">
                                            <label>Email</label>
                                ...
                                <fieldset> <br>
                                    ...
                                    <div class="form-check form-check-inline">
                                        <input class="form-check-input" type="radio" name="payment" id="inlineRadio1" value="paystack">
...
<!--                                        <div class="row">
                                            <div class="form-group form-float ">
                                                  <button type="button" name="submit" class="btn btn-danger btn-lg">Proceed to Payment</button>
                                            </div>
                                        </div>-->
                                        <div class="row">
                                            <div class="form-group form-float">
