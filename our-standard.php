...
?><div class="breadcrumb-area">
    <div class="breadcrumb-top default-overlay bg-img pt-100 pb-95" style="background-image:url(assets/img/art.jpg);">
        <div class="container">
            <h2>Our Standard</h2>
            <p>
            Our College is committed to a balanced and broad-based curriculum through which every student can 
            fulfil not only his or her academic potential, but their ultimate purpose for existence. Much more than 
            mundane education, we stand upon biblical principles and values which are inculcated into both staff 
            and students alike.
            </p>
        </div>
    </div>
    <div class="breadcrumb-bottom">
        <div class="container"> 
            <ul>
                <li><a href="index">Home</a> <span><i class="fa fa-angle-double-right"></i> Our Standard</span></li>
            </ul>
        </div>
    </div>
</div>
    ...
    <div class="container">
        <div class="row">
                        ...
                        <div class="col-lg-6 col-md-6">
                            <div class="single-about-chose-us mb-95">
                                <div class="about-choose-img">
                                    <img src="assets/img/icon-img/service-1.png" alt="">
                                </div>
                                <div class="about-choose-content text-green">
                                    <h3>Future Centered</h3>
                                    <span>
                                        TRICOL is a future-centered College, passionate about building a bridge between who and what a child is today and what he will be tomorrow.
                                    </span>
                                </div>
                            </div>
                        </div>
                        <div class="col-lg-6 col-md-6">
                            <div class="single-about-chose-us mb-95 about-negative-mrg">
                                ...
                                <div class="about-choose-content text-green">
                                    ...
                                    <span>
                                        Our College is committed to a balanced and broad-based curriculum through which every student can fulfil his or her academic potential.
                                    </span>
                                </div>
                            </div>
                        </div>
                        <div class="col-lg-6 col-md-6">
                            <div class="single-about-chose-us mb-95">
                                ...
                                <div class="about-choose-content text-green">
                                    <h3>Facilities</h3>
                                    <span>
                                        Modestly stocked with the latest non-fiction, classics and fiction books, alongside a comprehensive reference section, the TRICOL library is the central resource centre of the college community.
                                    </span>
                                </div>
                            </div>
                        </div>
            ...
            <div class="col-lg-4 col-md-12">
                <div class="about-img">
                    <img src="assets/bgs/img_stu3.png" alt="">
                </div>
            </div>
        </div>
    </div>
