...
?><div class="breadcrumb-area">
    <div class="breadcrumb-top default-overlay bg-img pt-100 pb-95" style="background-image:url(assets/img/art.jpg);">
        <div class="container">
            <h2>CORE VALUES</h2>
            <p>Academic Excellence  Professionalism   Integrity    Christian Values    Leadership     Responsibility</p>
        </div>
    </div>
    <div class="breadcrumb-bottom">
        <div class="container">
            <ul>
                <li><a href="#">Home</a> <span><i class="fa fa-angle-double-right"></i> Vision & Mission</span></li>
            </ul>
        </div>
    </div>
</div>
                        ...
                        <div class="col-lg-6 col-md-6">
                            <div class="single-about-chose-us mb-95">
                                ...
                                <div class="about-choose-content text-green">
                                    <h3>Our Standard</h3>
                                    <span class="text-center">Our College is committed to a balanced and broad-based curriculum through which every student can fulfil his or her academic potential.</span>
                                </div>
                            </div>
                        </div>
                        <div class="col-lg-6 col-md-6">
                            <div class="single-about-chose-us mb-95 about-negative-mrg">
                                ...
                                <div class="about-choose-content text-green">
                                    ...
                                    <span class="text-center">TRICOL is unique in many ways. As a College, we are judged by the quality of our teaching, results and the character of our students.  </span>
                                </div>
                            </div>
                        </div>
                    </div>
