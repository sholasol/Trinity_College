...
?><div class="breadcrumb-area">
    <div class="breadcrumb-top default-overlay bg-img pt-100 pb-95" style="background-image:url(assets/img/art.jpg);">
        <div class="container">
            <h2>Affliates</h2>
            <p>TRICOL is a future-centered College, passionate about building a bridge between who and what a child is today and what he will be tomorrow.</p>
        </div>
    </div>
    <div class="breadcrumb-bottom">
        <div class="container">
            <ul>
                <li><a href="index">Home</a> <span><i class="fa fa-angle-double-right"></i> <a href="affiliates/index">Login</a> | <a href="register">Register</a></span></li>
            </ul>
        </div>
    </div>
</div>
    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-6 col-md-6">
                <div class="single-about-chose-us mb-95">
                    ...
                    <div class="about-choose-content text-green">
                        <h3>Instruction Page</h3><br>
                        <span><h4>* Click on the affiliate tab on our website.</h4></span>
                        <br>
                        <span><h4>* Read through the registration instruction</h4></span>
                        <br>
                        <span>
                            <h4> * Click proceed to registration button.</h4>
                        </span>
                        <br>
                        <span>
                           <h4> * Fill the registration form and generate your referral code. </h4>
                        </span>
                        <br>
                        <span>
                           <h4> * Login in to the affiliate portal with your email and password</h4>
                        </span>
                        <br>
                        <span>
                           <h4> * Share your affiliate referral link on social media, ads etc.</h4>
                        </span>
                        <br>
                        <span>
                           <h4> * Get paid as students registers through your link.</h4>
                        </span>
                    </div>
                </div>
            </div>
            <div class="col-lg-6 col-md-12">
                <div class="about-img">
                    <img src="assets/bgs/affiliate.jpeg" width="600" height="300" alt="">
                </div>
                <div class="about-text mb-30"><br>
                    <a class="animated default-btn btn-white-color" href="register">Proceed to Regsiter <i class="fa fa-arrow-right"></i></a>
                </div>
            </div>
...
<div class="event-area bg-img default-overlay pt-130 pb-130" style="background-image:url(assets/img/bg/event-1.jpg);">
    <div class="container">
        ...
        <div class="event-active owl-carousel nav-style-1">
            <div class="single-event event-white-bg">
                <div class="event-img">
                    <a href="event-details"><img src="assets/img/event/exam.jpg" alt=""></a>
                    <div class="event-date-wrap">
                        <span class="event-date">8th</span>
                        <span>Feb</span>
                    </div>
                </div>
                <div class="event-content">
                    <h3><a href="event-details">MOCK (SS3 / BASIC 9)</a></h3>
                    <span>
                        MONDAY, FEBURUARY 8, -WEDNESDAY, FEBURUARY 17, 2021
                    </span>
            ...
            <div class="single-event event-white-bg">
                <div class="event-img">
                    <a href=""><img src="assets/img/event/entrance.jpg" w alt=""></a>
                    <div class="event-date-wrap">
                        <span class="event-date">6th</span>
                        <span>Feb</span>
                    </div>
                </div>
                <div class="event-content">
                    <h3><a href="">ENTRANCE EXAMINATION</a></h3>
                    <span>SATURDAY, FEBURUARY 6, 2021</span>
                    <div class="event-meta-wrap">
                        <div class="event-meta">
                            <i class="fa fa-location-arrow"></i>
                            <span>Ofada</span>
            ...
            <div class="single-event event-white-bg">
                <div class="event-img">
                    <a href="event-details"><img src="assets/img/event/award.jpg"  alt=""></a>
                    <div class="event-date-wrap">
                        <span class="event-date">19th</span>
                        <span>Jan</span>
                    </div>
                </div>
                <div class="event-content">
                    <h3><a href="event-details">AWARD CEREMONY</a></h3>
                    <span>TUESDAY, JANUARY 19th, 2021</span>
                    <div class="event-meta-wrap">
                        <div class="event-meta">
                            <i class="fa fa-location-arrow"></i>
                            <span>Ofada</span>
            ...
            <div class="single-event event-white-bg">
                <div class="event-img">
                    <a href="event-details"><img src="assets/img/event/back.png"  alt=""></a>
                    <div class="event-date-wrap">
                        <span class="event-date">9th</span>
                        <span>Jan</span>
                    </div>
                </div>
                <div class="event-content">
                    <h3><a href="event-details">RESUMPTION</a></h3>
                    <p>SATURDAY, JANUARY 9 AND SUNDAY , JANUARY 10, 2021. </p>
                    <div class="event-meta-wrap">
                        <div class="event-meta">
                            <i class="fa fa-location-arrow"></i>
                            <span>Ofada</span>
