                ...
                <div class="section__content section__content--w1760">
                    <div class="slide-wrapper js-slick-wrapper" data-slick-autoplay="true" data-slick-fade="true">
                        <div class="slide__content js-slick-content">
                            <?php 
                                $user = dbConnect()->prepare("SELECT * FROM slidder WHERE status=? ORDER BY rand() LIMIT 5");
                                $user->execute([1]);
                                while($sl = $user->fetch()){
                                ?>
                            <div class="slide-item">
                                <img src="../uploads/<?php echo $sl['image'];?>" alt="Slide 1">
                                <div class="slide__caption js-first-slick clearfix d-none d-lg-block" data-animation="fadeInUp" data-animation-delay=".1s">
                                    <div class="number float-left"><?php echo $sl['id'];?></div>
                                    <h2 class="text"><?php echo $sl['description'];?></h2>
                                </div>
                            </div>
...
<!--                             <div class="slide-item">
                            ...
                            <div class="slide-item">
                                <img src="images/slide-03.jpg" alt="Slide 1">
                                <div class="slide__caption js-first-slick clearfix d-none d-lg-block" data-animation="fadeInUp" data-animation-delay=".1s">
                ...
                <div class="rev_slider fullwidthabanner js-rev" data-version="5.4.5" style="display:none;" data-rev-layout="auto" data-rev-bullets="false" data-rev-height="900">
                    <ul>
                        ...
                        <li class="rev-item" data-transition="fadefromtop">
                            <img class="rev-slidebg" src="../uploads/<?php echo $sl['image'];?>" alt="Trinity">
                            ...
                            data-x="['center']" data-y="['center']" data-voffset="[-85,-85,-60,-55,-30]" data-width="['auto']" data-height="[&quot;auto&quot;]">We are</h2>
                            ...
                            data-x="['center']" data-y="['center']" data-voffset="[0]" data-width="['auto']" data-height="[&quot;auto&quot;]" data-fontsize="[48, 48, 34, 26, 30]">
                                <span class="text-container js-text-trans" data-background="images/slide-18-over.jpg">
                                    <span>professional film studio</span>
                                </span>
                            </h2>
                            ...
                            data-x="['center']" data-y="['center']" data-voffset="[100,100,85,70,60]" data-width="['auto']" data-height="[&quot;auto&quot;]">
                                <a class="au-btn au-btn--border au-btn--white" href="contact.html">hire us now</a>
                            </div>
                        </li>
                         <?php }?>
                    </ul>
                ...
                <div class="row m-t-60">
                    ...
                    <div class="col-lg-2">
                        <div class="who-ami__title">
                            ...
                            <a href="../../contact" class="au-btn au-btn--dark">contact now</a>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="section__content section__content--w1760">
                    <div class="row row-special">
                        ...
                        <?php 
                            ...
                            $user = dbConnect()->prepare("SELECT * FROM Students WHERE s_category=? ORDER BY rand() LIMIT 3");
                            $user->execute([1]);
                            while($nc = $user->fetch()){
                            ?>
                        <div class="col-25">
                            <div class="latest-work__item">
                                ...
                                <div class="image">
                                    ...
                                    <img src="../uploads/<?php echo $nc['image'] ;?>" alt="Trinity International College"  />
                                </div>
                                <div class="body">
                    ...
                    <?php 
                            ...
                            $user = dbConnect()->prepare("SELECT * FROM Facilities WHERE s_category=? ORDER BY rand() LIMIT 4");
                            $user->execute([1]);
                            while($nc = $user->fetch()){
                            ?>
                        <div class="col-25">
                    ...
                    <?php }?>
                        <?php 
                            ...
                            $user = dbConnect()->prepare("SELECT * FROM Events WHERE s_category=? ORDER BY rand() LIMIT 4");
                            $user->execute([1]);
                            while($nc = $user->fetch()){
                            ?>
                        <div class="col-25">
                    ...
                    <?php }?>
                        <!--<div class="col-25">
                            <div class="latest-work__item">
                                ...
                                <div class="image">
                                    <div class="bg-overlay"></div>
                                    <img src="images/lastest-work-02.jpg" alt="gem of the sea" />
                                </div>
                                <div class="body">
                                    <h3>gem of the sea</h3>
                                </div>
                            </div>
                        </div>
                        <div class="col-25">
                        ...
                        <div class="col-25">
                            <div class="latest-work__item">
                                ...
                                <div class="image">
                                    <div class="bg-overlay"></div>
                                    <img src="images/lastest-work-07.jpg" alt="Historical Ocean" />
                                </div>
                                <div class="body">
                                    <h3>Historical Ocean</h3>
                                </div>
                            </div>
                        </div>-->
                    </div>
            ...
            <div class="container">
                ...
                <div class="recent-blog__item clearfix">
                    <div class="image-wrap float-lg-left">
                        <div class="image">
                            <a href="blog-detail.html">
                                <img src="../uploads/motivate.jpg" alt="PHOTOGRAPHY IS A FORM OF TIME TRAVEL" />
                            </a>
                        </div>
                    ...
                    <div class="content content--right">
                        <h2 class="title">
                            <a href="blog-detail.html">EDUCATION BY INSPIRATION</a>
                        </h2>
                ...
                <div class="recent-blog__item clearfix">
                    <div class="image-wrap float-lg-right">
                        <div class="image">
                            <a href="blog-detail.html">
                                <img src="../uploads/award-1.jpg" alt="SHOOT WHAT YOU LOVE" />
                            </a>
                        </div>
                    ...
                    <div class="content content--left">
                        <h2 class="title">
                            <a href="blog-detail.html">Our Achievement</a>
                        </h2>
                        <p class="date">March 24 2017</p>
                        <p class="text">There is no magic to achievment. It's really hard work, choices and persistence.</p>
                        <a class="au-btn au-btn--border au-btn--p40 au-btn--border-6" href="blog-detail.html">read more</a>
                    </div>
                </div>
            </div>
        </section>
                        ...
                        <div class="col-25">
                            <div class="lastest-work__intro">
                                ...
                                <div class="lastest-work__intro-inner">
                                    ...
                                    <p class="lastest-work__text">
                                        Sed ut perspiciatis unde omnis iste natus error sit voluptatem accemque bo.
                                    </p>
                                </div>
                            </div>
                        </div>
       ...
       <section class="recent-blog p-t-70">
            <div class="container">
                ...
                <div class="recent-blog__item clearfix">
                    ...
                    <div class="content content--right">
                        <h2 class="title">
                            <a href="blog-detail.html"><?php echo $nc['title'];?></a>
                        </h2>
