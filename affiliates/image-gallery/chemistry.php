...
<section class="slide-6">
    <div class="rev_slider_wrapper fullwidthbanner-container">
        <div class="rev_slider fullwidthabanner js-rev" data-version="5.4.5" style="display:none;" data-rev-layout="auto" data-rev-bullets="false" data-rev-height="900">
            <ul>
                <?php 
                    $us = dbConnect()->prepare("SELECT * FROM imgUpload WHERE page='physics' ORDER BY rand() ");
                    $us->execute();
                    while($sl = $us->fetch()){
                    ?>
            ...
            <div class="row m-t-60">
                <div class="col-lg-10">
                    <div class="who-ami__img">
                        <iframe width="986" height="452" src="https://www.youtube.com/embed/_zY61Z0m8qQ" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
                    </div>
                </div>
                <div class="col-lg-2">
                        <div class="who-ami__title">
                            <div class="who-ami__title-text wow fadeInLeft" data-wow-delay=".4s">CHEMISTRY LABORATORY</div> <br>
                ...
                <div class="section__content section__content--w1760">
                    <div class="row row-special">
                        ...
                        <?php 
                            ...
                            $user = dbConnect()->prepare("SELECT * FROM imgUpload WHERE page='facility' ORDER BY rand() LIMIT 11");
                            $user->execute();
                            while($nc = $user->fetch()){
                            ?>
                        <div class="col-25">
