...
<section class="slide-6">
    <div class="rev_slider_wrapper fullwidthbanner-container">
        <div class="rev_slider fullwidthabanner js-rev" data-version="5.4.5" style="display:none;" data-rev-layout="auto" data-rev-bullets="false" data-rev-height="900">
            <ul>
                <?php 
                    $us = dbConnect()->prepare("SELECT * FROM imgUpload WHERE page='hostel' ORDER BY rand() ");
                    $us->execute();
                    while($sl = $us->fetch()){
                    ?>
                ...
                <div class="section__content section__content--w1760">
                    <div class="row row-special">
                        ...
                        <?php 
                            ...
                            $user = dbConnect()->prepare("SELECT * FROM imgUpload WHERE page='hostel' ORDER BY rand() LIMIT 11");
                            $user->execute();
                            while($nc = $user->fetch()){
                            ?>
                        <div class="col-25">
