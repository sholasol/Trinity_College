                            ...
                            if(Token::check(Input::get('token'))){
                                ...
                                if($validation->passed()){
                                    ...
                                    if($login){
                                        ...
                                        if($status == 'Active' && $role =='Admin' && $grp==1){
                                            //Staff
                                            echo  " <script> window.location='system/index'</script>";
                                        }elseif($status== 'Active' && $role=='Admin' && $grp==2){
                                            //Super Admin
                                        ...
                                        echo  " <script> alert('Oops! Check account status');window.location='index'</script>";
                                        }
                                }else {
