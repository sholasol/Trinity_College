        ...
        <div class="container-fluid">
            ...
            <div class="row clearfix">
                <div class="col-lg-12 col-md-12 col-sm-12">
                    <div class="card">
                        <div class="header">
                            <h2><strong>List of Slider Images</strong> 
                    ...
                    <div class="body">
                        <div class="body">
                            ...
                            <!-- <table class="table table-hover c_table theme-color dataTable js-exportable"> -->
                                ...
                                <tbody>
                                    <?php 
                                    $user = DB::getInstance()->query("SELECT * FROM slidder");
                                    if($user ->error()){
                                    ...
                                    <tr>
                                       ...
                                       <td> <label class="badge <?php if($up->status ==0){echo 'badge-danger';}else{echo 'badge-success';} ?>"> <?php if($up->status ==0){echo 'Disabled';}else{echo 'Approved';} ?> </label></td>
...
<div class="modal fade" id="defaultModal" tabindex="-1" role="dialog">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="title" id="defaultModalLabel">Create New Slidder</h4>
            </div>
            <div class="modal-body"> 
                <div class="card">
                        <div class="body">
